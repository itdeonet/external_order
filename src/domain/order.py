...
Defines `Order` and `OrderStatus`. Orders validate inputs and are immutable.
"""
...
class Order:
    ...
    Contains shipping info and line items. Validates inputs on creation.
    """
    ...
    def __post_init__(self) -> None:
        """Validate fields; raise ValueError on invalid input."""
    ...
    def set_sale_id(self, value: int) -> None:
        """Set internal `sale_id`; requires a positive integer."""
